import ViewQuizComponent from "@/pages/view-quiz-page/view-quiz-component"
...
describe("View Quizzes Page", () => {
    ...
    describe("With API handling", () => {
        ...
        it('renders message to user informing them that getting api data failed', async () => {
            ...
            expect(screen.getByTestId("ViewQuizFailMessage")).toBeInTheDocument()
        })
    })  
})
