...
export const buildQuizPage = "/quiz-building-page/quiz-building-component"
export const takeQuizPage = "/take-quiz-page/take-quiz-component" // Requires query param
